...
(async () => {
  console.log('🚀 Criando criativo para Facebook Ads...');
  ...
  try {
    ...
    // Ler o arquivo HTML
    const htmlPath = path.join(__dirname, 'facebook-ad-kit-manchas.html');
    ...
    // Salvar a imagem
    const outputPath = path.join(__dirname, 'facebook-ad-kit-manchas.jpg');
    fs.writeFileSync(outputPath, screenshot);
    
    console.log('✅ Criativo do Facebook Ads criado com sucesso!');
